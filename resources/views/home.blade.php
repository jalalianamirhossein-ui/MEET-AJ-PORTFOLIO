...
@verbatim
    ...
    <link href="/assets/css/site-modules.css?v=1848" rel="stylesheet" />
              ...
              <div class="hero-content">
                ...
                >
                  <p class="hero-subtitle">
                    ...
                    <span
                      class="typed"
                      data-typed-items="Infrastructure &amp; DevOps Engineer"
                      data-typed-items-fa="مهندس زیرساخت و DevOps"
                      aria-live="polite"
                      aria-atomic="true"
                      >Infrastructure &amp; DevOps Engineer</span
                    >
                  </p>
                </div>
          ...
          <div class="about-copy" data-aos="fade-up">
            ...
            <div class="about-profile">
              ...
              <div class="about-profile-meta">
                ...
                <p class="about-role" data-en="Infrastructure &amp; DevOps Engineer" data-fa="مهندس زیرساخت و DevOps">Infrastructure &amp; DevOps Engineer</p>
            ...
            <p class="about-lead" data-en="I am Amirhossein Jalalian, an Infrastructure &amp; DevOps Engineer with extensive experience in designing, managing, and optimizing enterprise systems. My goal is to provide reliable, secure, and scalable solutions that help organizations operate more efficiently while reducing risks." data-fa="من امیرحسین جلالیان هستم، مهندس زیرساخت و DevOps با تجربه گسترده در طراحی، مدیریت و بهینه‌سازی سیستم‌های سازمانی. هدف من ارائه راهکارهای پایدار، امن و مقیاس‌پذیر است که به سازمان‌ها کمک می‌کند کارآیی بیشتری داشته باشند و در عین حال ریسک‌ها را کاهش دهند.">
              I am Amirhossein Jalalian, an Infrastructure &amp; DevOps Engineer with extensive experience in designing, managing, and optimizing enterprise systems. My goal is to provide reliable, secure, and scalable solutions that help organizations operate more efficiently while reducing risks.
            </p>
      ...
      <section id="skills" class="skills section light-background">
        ...
        <!-- End Section Title -->
          ...
          <div class="skills-board skills-content skills-animation">
            <article class="skill-group" data-skill-domain="infrastructure">
            ...
            <article class="skill-group" data-skill-domain="networking">
              ...
              <div class="progress" data-skill-topic="security">
            ...
            <article class="skill-group" data-skill-domain="virtualization">
              ...
              <div class="progress" data-skill-topic="cloud">
              ...
              <div class="progress" data-skill-topic="database">
                <span class="skill"><span>SQL Server HA</span> <i class="val">80%</i></span>
                <div class="progress-bar-wrap"><div class="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div></div>
              </div>
            </article>
            <article class="skill-group" data-skill-domain="devops">
              ...
              <div class="progress" data-skill-topic="monitoring">
            ...
            <article class="skill-group" data-skill-domain="professional">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
              ...
              <div class="resume-item" data-resume-kind="certification"><h4
              ...
              <div class="resume-item" data-resume-kind="certification"><h4 data-en="LPIC-2" data-fa="LPIC-2">LPIC-2</h4>
                <h5>2023</h5>
                <p>
                  <em
                    ><a
              ...
              <div class="resume-item" data-resume-kind="certification"><h4 data-en="LPIC-1" data-fa="LPIC-1">LPIC-1</h4>
                <h5>2023</h5>
                <p>
                  <em
                    ><a
              ...
              <div class="resume-item" data-resume-kind="education"><h4
              ...
              <div class="resume-item" data-resume-kind="certification"><h4 data-en="MCSA & Network Plus" data-fa="MCSA و Network Plus">
                  MCSA & Network Plus
                </h4>
                <h5>2018</h5>
                <p>
              ...
              <div class="resume-item" data-resume-kind="certification"><h4 data-en="CCNA 200-125" data-fa="CCNA 200-125">
                  CCNA 200-125
                </h4>
                <h5>2018</h5>
                <p>
              ...
              <div class="resume-item" data-resume-kind="certification"><h4 data-en="Network Plus" data-fa="Network Plus">
                  Network Plus
                </h4>
                <h5>2013</h5>
                <p>
            ...
            <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="resume-item" data-resume-kind="experience"><h4
                  data-en="Infrastructure &amp; DevOps Engineer"
                  data-fa="مهندس زیرساخت و DevOps"
                >
                  Infrastructure &amp; DevOps Engineer
              ...
              <div class="resume-item" data-resume-kind="experience"><h4 data-en="Network Administrator" data-fa="ادمین شبکه">
